...
/****** Object:  StoredProcedure [postgresauditreport].[usp_Object_WrapProc_data]    Script Date: 21.07.2026 14:02:53 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER   PROCEDURE [postgresauditreport].[usp_Object_WrapProc_data_v2]
...
BEGIN
	...
	exec [postgresauditreport].[usp_objectperm_data_v2] @Parameters=@Parameters
