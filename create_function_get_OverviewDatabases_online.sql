...
--CREATE SCHEMA [MONGODBauditreport]
CREATE OR ALTER FUNCTION [MONGODBauditreport].[get_OverviewDatabases_online] (
...
FROM            MONGODB.T_SQLServerInstances AS tbl_inst 
	--ON tbl_serv.IDSQLServer = tbl_inst.IDSQLServer 
LEFT OUTER JOIN MONGODB.T_SQLDatabases AS tbl_dbs 
